        ...
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="pt-[72px]">
            <div className="max-w-[700px] mx-auto px-6 sm:px-8">
              <div className="space-y-6 text-lg text-zinc-700 leading-[1.75] text-left">
                <p>
              ...
              <div className="flex justify-center mt-8">
                <Link
                  href="/contact"
                  className="group flex h-14 items-center justify-center gap-3 rounded-full bg-black px-10 text-lg font-bold text-white transition-all hover:bg-zinc-800 shadow-lg hover:shadow-xl active:scale-95 whitespace-nowrap"
                >
                  Contact Us
