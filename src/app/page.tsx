...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-white">
      ...
      <section className="relative w-full -mt-20 pt-24 overflow-hidden mb-8">
        <div className="flex w-full items-center">
          ...
          {/* Center Logo Area */}
          <div className="flex-1 flex flex-col items-center justify-center z-10 px-4 h-[350px] md:h-[500px] py-10">
            <div className="relative w-full aspect-square max-w-[320px] md:max-w-[480px] mx-auto">
              {/* Fragment 1: Top Left */}
      ...
      <section className="w-full py-12 bg-white">
        <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="pt-10 flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-[60%] space-y-6 text-lg text-zinc-700 leading-[1.75] text-left">
              <p>
